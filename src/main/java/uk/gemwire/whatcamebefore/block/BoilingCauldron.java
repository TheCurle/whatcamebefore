package uk.gemwire.whatcamebefore.block;
...
public class BoilingCauldron extends Block {
    public static final IntegerProperty LEVEL = BlockStateProperties.LEVEL_0_3;

    public BoilingCauldron(Properties properties) {
        super(properties);
    ...
    public void onEntityCollision(BlockState state, World worldIn, BlockPos pos, Entity entityIn) {
        ...
        ((BoilingCauldronTE)worldIn.getTileEntity(pos)).handleItemDropped(entityIn);
    }
